...
$useridPage=$_GET["userid"];//le userid de la personne visitée



//recuperer des info sur la personne
...
$stm=$conn->query($sql);
$nopost=false;
//pour enlever la bouton automatiquement quand il y'a plus des postes à afficher
if($stm->rowCount()==0 or $stm->rowCount()<10){
    $nopost=true;
}

foreach($stm as $postdetail){
       $last_id=$postdetail['id'];//id  post
       ...
       //meme chose pour le dislike
        ...
        echo "<img src='./images/";
            ...
            echo "<div>
                <div class='post-username'><a href='./myPage.php?userid=".$useridPage."'>".$firstname.' '.$lastname." </a></div>
       ...
       echo"<div class='post-body'>
        ...
        <div class='like-edit-bar'>
            ...
            echo "<div class='comments' id='comments-".$postdetail['id']."'>";
                    ...
                    //des donnes à recupere pour appeler la fonction qui va faire l'ajax
